...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(235, 73);
			...
			this->label2->Size = System::Drawing::Size(736, 39);
			this->label2->TabIndex = 1;
			this->label2->Text = L"The Game is very efficient and basic, so enjoy.";
			// 
			// Credits
			// 
